...
import com.lms.library.dto.MemberDTO;
...
public class MemberServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /* Validate the request, if validation fails, we need to send appropriate response error */
//        System.out.println("Working.......!");
        ...
        try {
            ...
            try (Connection connection = pool.getConnection()) {
                ...
                stm = connection.prepareStatement("INSERT INTO member (nic, name, contact) VALUES (?,?,?)");                stm.setString(1, member.getNic());
